...
<html>
	<head>
	    ...
	    <title>AlgaWorks | Página Index</title>
	</head>
	...
	<body>
		...
		<section class="container">
			...
			<p><a href="<s:url value="/funcionarios"/>">Lista de Funcionários</a></p>
			
			<p><a href="<s:url value="/funcionarios/novo"/>">Cadastrar novo funcionário</a></p>
		...
		<div class="container">
		    ...
		    <footer>
		    	<h4>Artigo sobre Spring MVC</h4>
		    	
		    	<p>
					Esta é a página exibida após a ação <code>HomeController.index</code>.
				</p>
			</footer>	
		</div>
